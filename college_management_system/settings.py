...
SECRET_KEY = '6LfGVTkUAAAAAPi8n59Qd1GhCd2owrdclJaE2bjs'  # Consider using your secret key

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# ALLOWED_HOSTS = ['affluxconsulting.com']
ALLOWED_HOSTS = ['affluxconsulting.com']  # Not recommended but useful in dev mode
